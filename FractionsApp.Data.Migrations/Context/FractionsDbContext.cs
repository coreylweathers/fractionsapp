...
namespace FractionsApp.Data.Migrations.Context
{
    public class FractionsDbContext : DbContext
    {
        ...
        public DbSet<ProblemSetModel> ProblemSets { get; set; }
        public DbSet<FractionProblemModel> FractionProblems { get; set; }
        public DbSet<FractionModel> Fractions { get; set; }
